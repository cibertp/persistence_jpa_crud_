...
public class AlumnoJpaController implements Serializable {
    ...
    /*suspuest que se deveria de crearse una configuracion de persistence.*/
    public AlumnoJpaController() {
          //this.emf = Persistence.createEntityManagerFactory("percistenciaColeigioJPAPU");
          this.emf= Persistence.createEntityManagerFactory("persistenciaJPAPU");
